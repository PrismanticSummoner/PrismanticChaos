...
namespace Prism3.Accessories.Summoner
{
	...
	public abstract class WoodenSummonerAccessorie : ModItem
	{
		...
		protected (int index, Item accessory) FindDifferentEquippedExclusiveAccessory()
		{
			...
			for (int i = 3; i < 3 + maxAccessoryIndex; i++)
			{
				...
				if (!otherAccessory.IsAir &&
					...
					otherAccessory.modItem is WoodenSummonerAccessorie)
				{
	...
	public class SummonerAccessorieWood : WoodenSummonerAccessorie
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Increases minion damage by 50%");
		}
