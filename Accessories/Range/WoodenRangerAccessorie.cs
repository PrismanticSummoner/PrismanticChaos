...
namespace Prism3.Accessories.Range
{
	...
	public abstract class WoodenRangerAccessorie : ModItem
	{
		...
		protected (int index, Item accessory) FindDifferentEquippedExclusiveAccessory()
		{
			...
			for (int i = 3; i < 3 + maxAccessoryIndex; i++)
			{
				...
				if (!otherAccessory.IsAir &&
					...
					otherAccessory.modItem is WoodenRangerAccessorie)
				{
	...
	public class RangedAccessorieWood : WoodenRangerAccessorie
	{
