...
namespace Prism3.Accessories.Melee
{
	...
	public abstract class WoodenMeleeAccessorie : ModItem
	{
		...
		protected (int index, Item accessory) FindDifferentEquippedExclusiveAccessory()
		{
			...
			for (int i = 3; i < 3 + maxAccessoryIndex; i++)
			{
				...
				if (!otherAccessory.IsAir &&
					...
					otherAccessory.modItem is WoodenMeleeAccessorie)
				{
	...
	public class MeleeAccessorieWood : WoodenMeleeAccessorie
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Increases melee damage by 50%");
		}
