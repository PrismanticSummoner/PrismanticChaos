...
namespace Prism3.Accessories.Universal
{
	...
	public abstract class UniversalWoodenAccessorie : ModItem
	{
		...
		protected (int index, Item accessory) FindDifferentEquippedExclusiveAccessory()
		{
			...
			for (int i = 3; i < 3 + maxAccessoryIndex; i++)
			{
				...
				if (!otherAccessory.IsAir &&
					...
					otherAccessory.modItem is UniversalWoodenAccessorie)
				{
	...
	public class UniversalAccessorie : UniversalWoodenAccessorie
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Increases alll damage by 50%");
		}
