...
namespace Prism3.Accessories.Mage
{
	...
	public abstract class WoodenMagicAccessorie : ModItem
	{
		...
		protected (int index, Item accessory) FindDifferentEquippedExclusiveAccessory()
		{
			...
			for (int i = 3; i < 3 + maxAccessoryIndex; i++)
			{
				...
				if (!otherAccessory.IsAir &&
					...
					otherAccessory.modItem is WoodenMagicAccessorie)
				{
	...
	public class MagicAccessorieWood : WoodenMagicAccessorie
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Increases magic damage by 50%");
		}
